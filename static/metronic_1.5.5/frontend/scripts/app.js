var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", "/static/metronic_1.5.5/frontend/css/themes/" + color + (isRTL ? '-rtl' : '') + ".css");
            $('#logoimg').attr("src", "/static/metronic_1.5.5/frontend/img/logo_" + color + ".png");
            $('#rev-hint1').attr("src", "/static/metronic_1.5.5/frontend/img/sliders/revolution/hint1-" + color + ".png");
            $('#rev-hint2').attr("src", "/static/metronic_1.5.5/frontend/img/sliders/revolution/hint2-" + color + ".png");
        }
